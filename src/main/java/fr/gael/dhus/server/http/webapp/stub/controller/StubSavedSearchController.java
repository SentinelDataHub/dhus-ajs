...
public class StubSavedSearchController
{
   ...
   public void storeUserSearch(@PathVariable(value = "userid")
         final String userid,
         ...
         final String complete)
   {
      ...
      final User u = securityService.getCurrentUser();
   ...
   public List<Search> getUserSearches(@PathVariable(value = "userid")
   ...
   public int getUserSearchesCount(@PathVariable(value = "userid")
         final String userid)
   {
      int count = 0;
      final fr.gael.dhus.service.UserService userService =
   ...
   public void clearSavedSearches(@PathVariable(value = "userid")
         final String userid)
   {
      final fr.gael.dhus.service.UserService userService =
         ApplicationContextProvider
   ...
   public void removeUserSearch(@PathVariable(value = "userid")

        ...
        return {
          ...
          post: function(scope, iElem, iAttrs){
            ...
            scope.setToolbarInfo = function() {
                ...
                scope.show_newgui_link = ApplicationService.settings.show_newgui_link;
                scope.newgui_link = ApplicationService.settings.newgui_link;
            ...
            scope.goToNewUI = function() {
                ...
                if(!isChrome) {
                  alert("Browser not supported. \nThis web application currently is available only on browser supporting web components.");
                  return;
                }

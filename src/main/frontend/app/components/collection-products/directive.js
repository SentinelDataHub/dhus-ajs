                ...
                compile: function (tElem, tAttrs) {
                    ...
                    return {
                        ...
                        post: function (scope, iElem, iAttrs) {
                            ...
                            AdminCollectionManager.setCollectionProducts(function (details, isEmpty) {
                                scope.getCollectionProducts(details, isEmpty)
                            });
                            AdminCollectionManager.setAddedIdsFromComponent(function () {
                                return scope.getAddedIdsFromComponent()
                            });
                            AdminCollectionManager.setRemovedIdsFromComponent(function () {
                                return scope.getRemovedIdsFromComponent()
                            });
                            AdminCollectionManager.resetProductIds(function () {
                                return scope.resetProductIds()
                            });
                            ...
                            scope.resetProductIds = function () {
                                addedIds.splice(0, addedIds.length);
